...
const EVChargingGuide_Dashboard = ({ database }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-100">
      ...
      {/* ROW 1: HERO SECTION */}
      {/* ROW 1: HERO SECTION */}
<header className="relative w-full min-h-[75vh] bg-gradient-to-br from-white via-slate-50 to-slate-100 py-24 px-8 overflow-hidden flex items-center">
  ...
  className="inline-flex items-center gap-2 px-9 py-12 bg-red-600 text-white text-lg font-semibold rounded-xl transition-all duration-300 hover:bg-red-700 hover:scale-105 shadow-lg hover:shadow-[0_0_30px_rgba(220,38,38,0.6)]"
>
  Explore the Guide
  <ArrowRight size={20} />
</button>
  ...
  // Padding for the 3-column dashboard section is controlled here and in the 3 column containers below.
                  ...
                  <div className="bg-slate-50 rounded-2xl border border-slate-200 p-24">
                    ...
                    <div className="relative">
                      ...
                      <input 
                        ...
                        className="w-full pl-14 pr-4 py-3.5 bg-white border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all"
                        value={searchTerm}
