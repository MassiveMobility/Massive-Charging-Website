...
export default function Home_SectionF_VIPMembership() {
  ...
  return (
    <section className="relative w-full bg-[#050607] py-10 md:py-14">
      {/* Subtle premium glow */}
      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center">
        {/* Kicker */}
        <div className="mx-auto inline-flex items-center gap-2 rounded-full bg-[rgba(255,215,110,0.12)] px-3 py-1 text-xs font-semibold text-[rgba(255,215,110,0.95)]">
          {content.kicker}
        </div>
